...
🔍 Currently exploring opportunities in digital analytics, product data analysis, and data engineering.
...
Analytics Areas: Funnel analysis, A/B testing, user behavior, performance dashboards

Others: Git, Google Analytics, Jira
